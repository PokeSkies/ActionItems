...
object Utils {
    ...
    fun printDebug(message: String?, bypassCheck: Boolean = false) {
        if (bypassCheck || ConfigManager.CONFIG.debug)
            ActionItems.LOGGER.info("[${ActionItems.MOD_NAME}] DEBUG: $message")
    }

    fun printError(message: String?) {
        ActionItems.LOGGER.error("[${ActionItems.MOD_NAME}] ERROR: $message")
    }

    fun printInfo(message: String?) {
        ActionItems.LOGGER.info("[${ActionItems.MOD_NAME}] $message")
    }
